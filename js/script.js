...
function abrirModalItem(nome, preco, descricao, estoque) {
    document.getElementById('modal-descricao').textContent = `${nome} - ${descricao}`;
...
function adicionarAoCarrinho() {
    const nome = document.getElementById('modal-descricao').textContent.split(' - ')[0];
...
function verMais() {
    ...
    container.innerHTML += `
        <div class="cardapio-item animate__fadeIn">
            <img src="img/burger4.jpg" alt="Burger Especial" class="card-img-top">
            <div class="card-body bg-black text-white">
                <h5 class="card-title">Burger Especial</h5>
                <p class="card-text">R$22,00</p>
                <button class="btn btn-orange" onclick="abrirModalItem('Burger Especial', 22.00, '150g, queijo duplo, bacon.', 50)">Adicionar</button>
            </div>
        </div>
    `;
    alert('Mais itens carregados!');
}
