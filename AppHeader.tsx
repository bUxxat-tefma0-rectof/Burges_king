...
export const AppHeader = () => {
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b bg-card px-6 shadow-card">
      {/* Search */}
          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuItem className="flex flex-col items-start gap-1 py-3">
              ...
              <span className="text-sm text-muted-foreground">
                Maria Silva agendou para amanhã às 14h
              </span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1 py-3">
              <span className="font-medium">Pagamento recebido</span>
              <span className="text-sm text-muted-foreground">
                R$ 150,00 de João Santos
              </span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1 py-3">
              <span className="font-medium">Avaliação recebida</span>
              <span className="text-sm text-muted-foreground">
                Cliente deixou 5 estrelas
              </span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
